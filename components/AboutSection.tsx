...
const TIMELINE_ITEMS: RawItem[] = [
  ...
  { side: 'right', period: '2024年', when: '2024/10', role: 'インタビューライター養成講座', description: 'LOCAL LETTERにて、地域密着の取材・執筆を実践' },
  { side: 'right', period: '2024年', when: '2024/06', role: '地域バイヤープログラム', description: '株式会社WHEREにて、生産者訪問〜仕入れ〜AKOMEYA TOKYOでのPOPUP販売まで担当' },
