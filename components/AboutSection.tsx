...
const TIMELINE_ITEMS: RawItem[] = [
  ...
  { side: 'right', period: '〜2025年', when: '2025/02', role: 'コミュニティマネージャー', description: '地域バイヤープログラムで受講生とのコミュニケーションを担当' },
  { side: 'right', period: '2024年', when: '2024/10', role: 'インタビューライター養成講座', description: '株式会社WHEREにて、地域密着の取材・執筆を実践' },
  { side: 'right', period: '2024年', when: '2024/06', role: '地域バイヤープログラム', description: '生産者訪問〜仕入れ〜AKOMEYA TOKYOでのPOPUP販売まで担当' },
  { side: 'right', period: '2023年〜2024年', range: ['2023/04', '2024/03'], role: "G's Devコース", description: 'HTML/CSS/PHP/Laravel、Next.js/React などを学習' },
  { side: 'right', period: '2022年', range: ['2022/04', '2022/12'], role: 'SAMURAI ENGINEER エキスパート', description: 'HTML/CSS/PHP/Laravel を学習' },
